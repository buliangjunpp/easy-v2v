...
from v2v.common import cmdutils
from v2v.common import concurrent
from v2v.common import libvirtconnection
from v2v.common import password
from v2v.common import response
from v2v.common.cmdutils import wrap_command
from v2v.common.commands import execCmd, BUFFSIZE, terminating
from v2v.common.config import config
from v2v.common.define import errCode, doneCode
from v2v.common.logutils import traceback
from v2v.common.time import monotonic_time
from v2v.common.units import MiB
from v2v.constants import P_VDSM_LOG, P_VDSM_RUN, EXT_KVM_2_OVIRT
from v2v.utils import NICENESS, IOCLASS
...
def get_jobs_status():
    ret = {}
    with _lock:  # pylint: disable=not-context-agent
